...
device = await navigator.bluetooth.requestDevice({filters:[{namePrefix:"uBit"}], optionalServices: ["accb4ce4-8a4b-11ed-a1eb-0242ac120002"]});
server = await device.gatt.connect()
services = await server.getPrimaryServices() 
chars = await services[0].getCharacteristics()
